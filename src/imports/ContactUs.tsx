import svgPaths from "./svg-0vmr3y62d3";
...
function Frame1() {
  return (
    <div className="absolute h-[592px] left-[calc(50%-1.5px)] overflow-clip top-[980px] translate-x-[-50%] w-[1283px]">
      <Group10 />
      <Social />
    </div>
  );
...
function Group11() {
  return (
    <div className="absolute contents left-[651px] top-[451px]">
      <BackgroundImage additionalClassNames="left-[651px] top-[451px] w-[311px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[29.33%_44.06%_69.21%_52.03%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Email
      </p>
    </div>
  );
...
function Group15() {
  return (
    <div className="absolute contents left-[320px] top-[451px]">
      <BackgroundImage additionalClassNames="left-[320px] top-[451px] w-[311px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[29.33%_69.61%_69.21%_26.17%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Name
      </p>
    </div>
  );
...
function Group12() {
  return (
    <div className="absolute contents left-[319px] top-[513px]">
      <BackgroundImage additionalClassNames="left-[319px] top-[513px] w-[643px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[33.27%_68.59%_65.27%_26.09%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Subject
      </p>
    </div>
  );
...
function Group14() {
  return (
    <div className="absolute contents left-[488px] top-[772px]">
      <div className="absolute bg-[#802367] h-[44px] left-[488px] rounded-[13px] top-[772px] w-[326px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[49.75%_47.34%_48.79%_49.06%] leading-[normal] text-[20px] text-nowrap text-white" style={{ fontVariationSettings: "'wdth' 100" }}>
        Send
      </p>
    </div>
  );
...
function Group13() {
  return (
    <div className="absolute contents left-[319px] top-[569px]">
      <div className="absolute bg-[#ededed] h-[148px] left-[319px] rounded-[13px] top-[569px] w-[643px]">
        <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_1px_4px_0px_rgba(0,0,0,0.25)]" />
      </div>
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[36.83%_67.5%_61.7%_26.09%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Message
      </p>
    </div>
  );
...
function Group16() {
  return (
    <div className="absolute contents left-[calc(50%+0.5px)] top-[343px] translate-x-[-50%]">
      <p className="absolute font-['Roboto:SemiBold',sans-serif] font-semibold leading-[normal] left-[495px] text-[#91086c] text-[35px] text-nowrap top-[343px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Send us a message
      </p>
      <Group11 />
      <Group15 />
...
export default function ContactUs() {
  return (
    <div className="bg-white relative size-full" data-name="Contact Us">
      <div className="absolute flex inset-[23.43%_60.61%_37.28%_-10.62%] items-center justify-center">
        <div className="flex-none h-[501.943px] rotate-[53.848deg] w-[398.169px]">
          <div className="relative size-full" data-name="Ellipse66">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 398.169 501.943">
              <path d={svgPaths.p3dfad400} fill="var(--fill-0, #FFDABC)" fillOpacity="0.1" id="Ellipse66" />
            </svg>
          </div>
        </div>
      </div>
      <div className="absolute flex inset-[37.02%_-7.69%_35.03%_76.8%] items-center justify-center">
        <div className="flex-none h-[361.8px] rotate-[20.48deg] w-[287px]">
          <div className="relative size-full" data-name="Ellipse66">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 287 361.8">
              <path d={svgPaths.p108fed00} fill="var(--fill-0, #FFDABC)" fillOpacity="0.1" id="Ellipse66" />
            </svg>
          </div>
        </div>
      </div>
      <Frame1 />
      <p className="absolute bg-clip-text bottom-[1375px] font-['Inter:Semi_Bold',sans-serif] font-semibold h-[67px] leading-[normal] left-[61px] not-italic text-[55px] translate-y-[100%] w-[306px]" style={{ WebkitTextFillColor: "transparent", backgroundImage: "linear-gradient(97.719deg, rgba(145, 8, 108, 0.9) 8.3319%, rgb(180, 66, 149) 75.162%)" }}>
        Contact Us
      </p>
      ...
      <HeroSection />
      <Frame />
      <div className="absolute bg-white h-[631px] left-[calc(50%+0.5px)] rounded-[13px] shadow-[0px_118px_33px_0px_rgba(0,0,0,0),0px_76px_30px_0px_rgba(0,0,0,0.01),0px_43px_26px_0px_rgba(0,0,0,0.05),0px_19px_19px_0px_rgba(0,0,0,0.09),0px_5px_10px_0px_rgba(0,0,0,0.1)] top-[299px] translate-x-[-50%] w-[771px]" />
      <Group16 />
    </div>
  );
}
