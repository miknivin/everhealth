  ...
  return (
    <div className="absolute contents left-[199px] top-[428px]">
      ...
      <div className="absolute aspect-[492/800] left-[29.38%] right-[58.36%] top-[536px]" data-name="ChatGPTImageDec17,2025,04_58_50PM11_8">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgChatGptImageDec172025045850Pm118} />
      </div>
      <div className="absolute aspect-[492/800] left-[15.55%] right-[64.92%] top-[428px]" data-name="ChatGPTImageDec17,2025,04_58_50PM11_8">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgChatGptImageDec172025045850Pm119} />
      </div>
    </div>
  );
}
