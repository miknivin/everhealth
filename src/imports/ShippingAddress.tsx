import svgPaths from "./svg-5u31ml0zun";
...
function Helper({ additionalClassNames = "" }: HelperProps) {
  return (
    <div className={clsx("absolute bg-[#ededed] h-[44px] rounded-[13px]", additionalClassNames)}>
      <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_1px_4px_0px_rgba(0,0,0,0.25)]" />
    </div>
  );
}
type BgProps = {
...
function Group11() {
  return (
    <div className="absolute contents left-[177px] top-[334px]">
      <Helper additionalClassNames="left-[177px] top-[334px] w-[451px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[23.24%_77.27%_75.2%_15%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        First Name
      </p>
    </div>
  );
...
function Group12() {
  return (
    <div className="absolute contents left-[652px] top-[334px]">
      <Helper additionalClassNames="left-[652px] top-[334px] w-[451px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[23.24%_40.31%_75.2%_52.11%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Last Name
      </p>
    </div>
  );
...
function Group13() {
  return (
    <div className="absolute contents left-[177px] top-[403px]">
      <Helper additionalClassNames="left-[177px] top-[403px] w-[451px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[27.91%_74.38%_70.54%_15%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        E-mail Address
      </p>
    </div>
  );
...
function Group15() {
  return (
    <div className="absolute contents left-[177px] top-[472px]">
      <Helper additionalClassNames="left-[177px] top-[472px] w-[451px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[32.57%_77.89%_65.88%_15%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Address 1
      </p>
    </div>
  );
...
function Group16() {
  return (
    <div className="absolute contents left-[652px] top-[472px]">
      <Helper additionalClassNames="left-[652px] top-[472px] w-[451px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[32.57%_40.78%_65.88%_52.11%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Address 2
      </p>
    </div>
  );
...
function Group17() {
  return (
    <div className="absolute contents left-[177px] top-[541px]">
      <Helper additionalClassNames="left-[177px] top-[541px] w-[451px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[37.23%_78.75%_61.22%_15%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Zip Code
      </p>
    </div>
  );
...
function Group19() {
  return (
    <div className="absolute contents left-[177px] top-[610px]">
      <Helper additionalClassNames="left-[177px] top-[610px] w-[926px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[41.89%_73.75%_56.55%_15%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Choose Country
      </p>
    </div>
  );
...
function Group18() {
  return (
    <div className="absolute contents left-[652px] top-[541px]">
      <Helper additionalClassNames="left-[652px] top-[541px] w-[451px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[37.23%_45.16%_61.22%_52.11%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        City
      </p>
    </div>
  );
...
function Group14() {
  return (
    <div className="absolute contents left-[652px] top-[403px]">
      <Helper additionalClassNames="left-[652px] top-[403px] w-[451px]" />
      <p className="absolute font-['Roboto:Medium',sans-serif] font-medium inset-[27.91%_37.42%_70.54%_52.11%] leading-[normal] text-[20px] text-[rgba(34,34,34,0.25)] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Phone Number
      </p>
    </div>
  );
...
function Group20() {
  return (
    <div className="absolute contents left-1/2 top-[334px] translate-x-[-50%]">
      <Group11 />
      <Group12 />
      <Group13 />
      <Group15 />
...
function RadixIconsBox() {
  return (
    <div className="absolute left-[177px] size-[34px] top-[699px]" data-name="radix-icons:box">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="radix-icons:box">
          <path d={svgPaths.p24be9100} fill="var(--fill-0, #E6E6E6)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame() {
  return (
    <div className="absolute bg-[#802367] content-stretch flex h-[48px] items-center justify-center left-[989px] overflow-clip px-[16px] py-[12px] rounded-[13px] top-[790px] w-[119px]">
      <p className="font-['Roboto:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[16px] text-nowrap text-white" style={{ fontVariationSettings: "'wdth' 100" }}>
        Continue
      </p>
    </div>
  );
...
function Frame3() {
  return (
    <div className="absolute bg-[rgba(124,95,71,0.1)] content-stretch flex h-[48px] items-center justify-center left-[177px] overflow-clip px-[16px] py-[12px] rounded-[13px] top-[790px] w-[119px]">
      <p className="font-['Roboto:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#802367] text-[16px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Back to cart
      </p>
    </div>
  );
...
export default function ShippingAddress() {
  return (
    <div className="bg-white relative size-full" data-name="Shipping Address">
      <Frame2 />
      ...
      <p className="absolute bottom-[1283px] font-['Inter:Semi_Bold',sans-serif] font-semibold h-[67px] leading-[normal] left-[61px] not-italic text-[55px] text-[rgba(34,34,34,0.75)] translate-y-[100%] w-[355px]">Our Products</p>
      ...
      <Frame1 />
      <Group20 />
      <div className="absolute flex inset-[42.23%_15.2%_56.78%_82.81%] items-center justify-center">
        <div className="flex-none h-[25.456px] rotate-[90deg] w-[14.728px]">
          <div className="relative size-full" data-name="Vector">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.7276 25.456">
              <path clipRule="evenodd" d={svgPaths.p3b859bf0} fill="var(--fill-0, #222222)" fillOpacity="0.75" fillRule="evenodd" id="Vector" />
            </svg>
          </div>
        </div>
      </div>
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] left-[215px] text-[20px] text-black text-nowrap top-[715.5px] translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal]">{` Same as billing address`}</p>
      </div>
      <RadixIconsBox />
      <Frame />
      <Frame3 />
